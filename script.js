...
const transcriptData = [
    { time: 0, text: "こちらはユニクロの長袖のオーバーシャツです。" },
    { time: 3.5, text: "サイズはLで、チェストは96から104cmです。" },
    { time: 7, text: "色は無地の薄い灰色で、落ち着いた色になっています。" },
    { time: 11, text: "この服はかけボタン式で、胸ポケットが両側にあることが特徴です。" },
    { time: 16, text: "素材は綿とナイロンの混紡です。" },
    { time: 19, text: "洗濯方法は洗濯機で40度までです。" },
    { time: 22.5, text: "カジュアルな場面で着ることのできる一着です。" }
];
