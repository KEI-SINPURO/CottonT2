...
const transcriptData = [
    ...
    { time: 3.5, text: "素材はハリ感のある、カジュアルなコットンで、肌ざわりがとても柔らかくて快適です。" },
    { time: 7, text: "シャツの生地は厚すぎず程よい厚みで、年間を通して着やすいです。" },
    { time: 11, text: "色は白に近い無地で、黒色の花柄模様が描かれています。" },
    { time: 16, text: "そのため、きちんと感があります。" },
    { time: 19, text: "形はやや細身でスマートなシルエットですが、動きやすさも考えられています。" },
    { time: 22.5, text: "カジュアルな場面で着ることができる1着です。" }
];
